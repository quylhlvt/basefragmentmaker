package com.chibi.avatar.chibimaker.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.chibi.avatar.chibimaker.utils.share.whatsapp.StickerContentProvider";
