package com.example.basefragment.data.model.addcharacter.draw
...
import com.example.basefragment.core.extention.toRect
...
abstract class Draw {
    ...
    abstract fun setAlpha(@IntRange(from = 0, to = 200) alpha: Int): Draw
